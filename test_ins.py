...
parser.add_argument('--output_dir',default='./output_mix_new1', type=str, help='output dir')
...
if __name__ == "__main__":
    ...
    snapshot = './output_mix_new/best_epoch_weights.pth'
    # snapshot = './output_4/epoch_99.pth'
    ...
    # log_folder = os.path.join(args.output_dir, "test_log/test_log_best")
    log_folder = os.path.join(args.output_dir, "test_log/test_log")
    ...
    if args.is_savenii:
        # args.test_save_dir = os.path.join(args.output_dir, "predictions_best")
